...
import { Prices } from "../components/FilterPrices"
...
const HomePage = () => {
  ...
  return (
    ...
    <Layout title={"ALl Products - Best offers "}>
      <div className="container-fluid row" id="title">
      ...
      <div className="container-fluid row " id="headermain">
        <div className="col-md-2">
          <h4 className="text-center">Filter By Services</h4>
            ...
            {products?.map((p) => (
              <div className="card m-2" style={{ width: "18rem" }} key={p._id}>
                ...
                <div className="card-body">
                  ...
                  <button
                    className="btn btn-secondary ms-1 mb-1"
                    onClick={() => {
                      setCart([...cart, p]);
